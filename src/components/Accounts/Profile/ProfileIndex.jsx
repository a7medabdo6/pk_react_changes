                ...
                {props.profile.loading ? (
                    ...
                    : <div className="new-home-box">
                        <div className="new-home-sidebar">
                            ...
                            <div className="sibebar-header-sec" style={{marginTop:"20vh"}}>
                                ...
                                <div>
                                    <h4 style={{background:"linear-gradient(90deg, rgba(249,206,52,1) 0%, rgba(238,42,123,1) 35%, rgba(98,40,215,1) 100%)",padding:"5px 10px ",borderRadius:
                                    "100px",color:"white",fontSize:"16px"}}>
                                        Unlock Premium Posts - $10.00</h4>
                                     <h4 style={{marginBlock:"10px",backgroundColor:"grey",padding:"5px 10px ",borderRadius:
                                    "100px",color:"white",fontSize:"16px"}}>Subscribe To Free Posts</h4>

                                    </div>
                             
                               
                            </div>
                            <div className="sidebar-links d-none">
                            ...
                            </div> */}
                            {
                                props.profile.data.youtube_link ||
                                    ...
                                    <div className="sidebar-social-links d-none">
                                        <ul className="list-unstyled">
                                            {props.profile.data.youtube_link && (
                                                <Media as="li">
                        ...
                        <div className="new-home-main-wrapper">
                            ...
                            <div className="user-right-content-sec" style={{height:"40vh"}}>
                            ...
                            <div className="profile-tab-sec">
                                <Tab.Container id="left-tabs-example" defaultActiveKey="all">
                                    <Row>
                                        <Col sm={12}>
                                            <Nav variant="pills" className="grid-six-col">
                                                <Nav.Item>
                                                ...
                                                <Nav.Item>
                                                    ...
                                                    <ServiceModal content={   <div className="user-info-list">
                                        <ul className="list-unstyled">
                                    ...
                                    </div>} btn={ <Nav.Item> <Nav.Link eventKey="Services"
                                                       >
                                                       
                                                        <span className="resp-display-none">Services</span>
                                                    </Nav.Link>
                                                </Nav.Item>}/>
                                                <AboutMeModal content={ <div className="sidebar-total-count-info-box">
                                        ...
                                        <p>{t("following")}</p>
                                                    ...
                                                    <Nav.Link eventKey="About"
                                                       >
                                                        ...
                                                        <span className="resp-display-none">About Me</span>
                                                    </Nav.Link>
                                                </Nav.Item>}/>
